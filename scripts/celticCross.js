...
// sets new value for range based on slider%
...
function pastPresentFuture() {
    ...
    for (let b = 1; b <= 10; b++) {
        ...
        if (randomInvert >= percentRevs) {
            ...
            $("#info-" + b).html("<h4><b>" + deck[random].displayName.toUpperCase() + "</b></h4>");
            $("#info-" + b).append(meanings.upright[random - 1].name);
        } else {
            $("#img-" + b).html(riderWaite(random).addClass("invert"));
            $("#info-" + b).html("<h4><b>" + deck[random].displayName.toUpperCase() + " - <i>Reversed</i></b></h4>");
